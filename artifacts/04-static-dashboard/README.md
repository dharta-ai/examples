...
dashboard. Its range buttons update the figures in the canvas without calling
an external service.

This is the last zero-lease example. It demonstrates software plus data while
remaining portable as immutable static files.
